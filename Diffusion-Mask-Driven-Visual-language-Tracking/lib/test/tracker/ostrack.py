...
class OSTrack(BaseTracker):
    def __init__(self, params, dataset_name):
        ...
        vocab_path = '/home/data/zgt/CVPR2024/OSTrack-main-diffusion/pretrained/bert/bert-base-uncased-vocab.txt'
    ...
    def track(self, image, info: dict = None):
        ...
        with torch.no_grad():
            ...
            out_dict = self.network.p_sample_loop(
                template=self.z_dict1.tensors, search=x_dict.tensors,text=self.text_input, ce_template_mask=self.box_mask_z)

            # for hook in hooks:
                # hook.remove()
                # vis_attn_maps(attn_weights, q_w=24, k_w=12, skip_len=0, x1=self.z_patch_arr, x2=x_patch_arr,
                #               x1_title='Template', x2_title='Search',
                #               save_path='/home/data/zgt/CVPR2024/OSTrack-main-diffusion/visual/%04d' % self.frame_id)
